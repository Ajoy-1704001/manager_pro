...
import 'package:managerpro/controller/user_edit_controller.dart';
import 'package:managerpro/utilities/layout.dart';
import 'package:managerpro/utilities/theme_helper.dart';
import 'package:managerpro/view/editProfile.dart';
...
// String ProfileName = "Ajoy Deb Nath";
  ...
  bool isLoad = false;
  UserEditController userEditController = Get.put(UserEditController());
                        ...
                        child: Column(
                          children: [
                            CircleAvatar(
                              radius: 70,
                              child: Image.asset(
                                  "assets/avatar/a${int.parse(userController.avatar.value) + 1}.png"),
                            ),
                            ...
                            ElevatedButton(
                              onPressed: () {
                                Get.to(EditProfile(
                                  avatar:
                                      int.parse(userController.avatar.value),
                                ));
                              },
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Column(children: [
                                  ...
                                  const SizedBox(height: 5),
                                  Text(
                                    userController.totalCompleted.value
                                        .toString(),
                                    style: TextStyle(
                                        color: ThemeHelper.textColor,
                                        fontSize: 20),
